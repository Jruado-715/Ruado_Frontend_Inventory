...
// Charts show real-time data — updated via WebSocket broadcasts.
...
const PIE_COLORS   = ["#E50914", "#3498db", "#2ecc71"];
...
const DashboardPage = () => {
  ...
  const suggestedLive = [...products]
    ...
    .map(p => ({
      ...p,
      reason:  p.stock < 4 ? "Critical — restock immediately" : "Stock running low",
      urgency: p.stock < 4 ? "Critical" : "Restock Soon",
    }));
  ...
  const pieData = ["Electronics","Furniture","Peripherals"]
